...
======================================================================
Pipeline preprocessing lengkap untuk ulasan CoretTax/M-Pajak.
...
SLANG_DICT = {
    ...
    "ngga": "tidak", "engga": "tidak", "enggak": "tidak", "tdk": "tidak",
    "gx": "tidak", "g": "tidak", "kaga": "tidak", "kagak": "tidak",
    "gabisa": "tidak bisa", "gabsa": "tidak bisa", "gaisa": "tidak bisa",
    "gbs": "tidak bisa", "gbsa": "tidak bisa", "gk bisa": "tidak bisa",
    "blm": "belum", "blom": "belum", "blum": "belum",
    "tp": "tapi", "tpi": "tapi",
    "krn": "karena", "karna": "karena", "krna": "karena",
    "utk": "untuk", "buat": "untuk", "u/": "untuk", "utuk": "untuk",
    ...
    "skrg": "sekarang", "skrng": "sekarang", "skrang": "sekarang",
    "sblm": "sebelum", "sblmnya": "sebelumnya",
    "msh": "masih", "masi": "masih", "msih": "masih",
    "slalu": "selalu", "sllu": "selalu",
    ...
    "tau": "tahu", "tw": "tahu",
    "mau": "mau", "mo": "mau", "mw": "mau",
    "pke": "pakai", "pake": "pakai", "pk": "pakai",
    "tlg": "tolong", "tlng": "tolong", "tlong": "tolong",
    "cb": "coba", "cba": "coba",
    "trs": "terus", "trus": "terus",
    "dtg": "datang", "dtng": "datang",
    "krj": "kerja", "krja": "kerja",
    "bkin": "bikin", "bkn": "bukan",
    ...
    # Kata benda & domain
    "app": "aplikasi", "apk": "aplikasi", "apl": "aplikasi", "aplksi": "aplikasi",
    "hp": "handphone", "hape": "handphone",
    "no": "nomor", "nmr": "nomor",
    "org": "orang", "orng": "orang",
    "info": "informasi",
    "srtifikat": "sertifikat", "srtfkt": "sertifikat",
    "akun": "akun",

    # Kata sifat
    "bgus": "bagus", "bgs": "bagus",
    "jlek": "jelek", "jlk": "jelek",
    "gmpng": "gampang", "gmpang": "gampang",
    "ssh": "susah",
    "lma": "lama", "lm": "lama",
    "cpet": "cepat", "cpt": "cepat",
    "byk": "banyak", "bnyk": "banyak",
    "sdkt": "sedikit", "sdkit": "sedikit",
    "kecil": "kecil", "kcl": "kecil",
    "bsr": "besar",

    # Sapaan & ekspresi
    "dong": "", "deh": "", "sih": "", "nih": "", "loh": "", "lah": "",
    "ya": "", "yaa": "", "yah": "",
    "woy": "", "woii": "", "woi": "",
    "pls": "tolong", "please": "tolong",
    "thx": "terima kasih", "tq": "terima kasih", "makasih": "terima kasih",
    "mksh": "terima kasih", "mkasih": "terima kasih",
    "sorry": "maaf", "sory": "maaf", "sori": "maaf",

    # Kata teknis (domain CoretTax/pajak)
...
def prepare_dataset(filepath: str = "data/raw/coretax_reviews.csv",
                    output_path: str = "data/processed/reviews_prepared.csv") -> pd.DataFrame:
    """
...
def _load_stopwords():
    ...
    try:
        ...
        stopwords_id = {
            'yang', 'di', 'ke', 'dari', 'dan', 'ini', 'itu', 'dengan',
            'untuk', 'pada', 'adalah', 'juga', 'saya', 'sudah', 'ada',
            'akan', 'atau', 'bisa', 'lebih', 'kalau', 'se', 'nya',
